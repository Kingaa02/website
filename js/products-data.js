...
const products = [
  {
    ...
    description:
      "Profesjonalna aktywna piana do mycia pojazdów osobowych. Silnie pieniący produkt, tworzy bardzo gęstą pianę, efekt śniegu. Zaawansowana formuła skutecznie usuwa brud, kurz drogowy i pozostałości owadów z powierzchni lakierowanych.",
    images: [
  ...
  },
  {
    ...
    category: "active-foam",
    description:
      "Zaawansowana aktywna piana do mycia pojazdów osobowych. Przeznaczona do twardej wody – zawiera zmiękczacze w składzie. Skutecznie usuwa zabrudzenia drogowe, tłuszcze i inne zanieczyszczenia, pozostawiając powierzchnię czystą i lśniącą.",
    images: [
    ...
    details: {
      features: [
        ...
        "Zmiękczacze w składzie – idealna do twardej wody",
  ...
  },
  {
    ...
    category: "active-foam",
    description:
      "Wysoko skoncentrowana aktywna piana do mycia pojazdów osobowych. Uniwersalny produkt do każdego typu wody. Tworzy pianę o średniej gęstości. Skutecznie usuwa brud drogowy, tłuszcze i inne zanieczyszczenia, pozostawiając powierzchnię czystą i lśniącą.",
    images: [
    ...
    details: {
      features: [
        "Wysokowydajna formuła aktywnej piany",
        "Uniwersalny do każdego typu wody",
        "Piana średniej gęstości",
        "Bezpieczna dla wszystkich rodzajów lakierów",
        "Doskonała przyczepność do powierzchni pionowych",
        "Łatwe spłukiwanie bez pozostawiania smug",
        "Ekonomiczne dozowanie",
  ...
  },
  {
    ...
    description:
      "Skoncentrowana aktywna piana do mycia pojazdów ciężarowych i maszyn. Silnie pieniący produkt, tworzy bardzo gęstą pianę. Skutecznie usuwa trudne zabrudzenia drogowe, tłuszcze i oleje, pozostawiając powierzchnię czystą.",
    images: [
  ...
  },
  {
    ...
    category: "active-foam-truck",
    description:
      "Zaawansowana aktywna piana do mycia pojazdów ciężarowych i maszyn. Mniej pieniąca, ale o silniejszym działaniu czyszczącym i odtłuszczającym. Skutecznie usuwa trudne zabrudzenia drogowe, tłuszcze i oleje, pozostawiając powierzchnię czystą.",
    images: [
  ...
  },
  {
    ...
    category: "active-foam-truck",
    description:
      "Zaawansowana aktywna piana do mycia pojazdów ciężarowych i maszyn. Mniej pieniąca niż Truck 1, ale o silniejszym działaniu czyszczącym i odtłuszczającym. Skutecznie usuwa trudne zabrudzenia drogowe, tłuszcze i oleje, pozostawiając powierzchnię czystą.",
    images: [
      "images/Active foam truck 5/Active_foam_truck_5_1.png", // 1kg
      "images/Active foam truck 5/Active_foam_truck_5_2.png",
      "images/Active foam truck 6/Active_foam_truck_6_1.png", // 5kg - 1
